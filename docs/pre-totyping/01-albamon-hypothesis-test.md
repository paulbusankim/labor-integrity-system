...
| :---------------------- | :----------------- | :---------------------- | :--------------------------------- |
| **자발적 입력 액션 수** | 24시간 내 5건 이상 | **1건**                 | 시급 10,450원 / 주 50시간 근무자   |
| **가설 판정**           | -                  | **목표 5건 미달인 1건** | 실제 타겟의 실데이터 1개 확보 성공 |
...
- **인사이트:**
  1. 배포 후 24시간이 채 되지 않은 시점에서 실제 타겟 유저의 자발적 로그(시급 10,450원, 주 50시간)를 확보.
